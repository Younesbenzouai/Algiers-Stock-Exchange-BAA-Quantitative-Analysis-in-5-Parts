...
et relance le script (ou la cellule, si tu es dans Jupyter) pour mettre a jour le graphique.
...
def _resolve_excel_path(default_path):
    ...
    fichier .xlsx present a cote de ce script (cas du depot GitHub, ou le classeur est
    inclus) > chemin par defaut ci-dessus. Ignore automatiquement les arguments injectes
    par Jupyter/IPython (ex: '-f ...kernel.json').
    """
